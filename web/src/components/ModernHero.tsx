...
export default function ModernHero() {
  return (
    <section className="relative min-h-[90vh] flex flex-col lg:flex-row">
      ...
      <div className="flex-1 bg-brand-navy flex items-center justify-center p-12 lg:p-20 relative overflow-hidden group">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <Link href="/get-started?type=seller" className="inline-flex items-center bg-brand-red hover:bg-red-700 text-white px-8 py-4 rounded-xl font-semibold transition-all hover:shadow-lg hover:shadow-red-900/50">
            Get Cash Offer →
          </Link>
        </div>
      </div>
      ...
      <div className="flex-1 bg-brand-sand flex items-center justify-center p-12 lg:p-20 relative group border-l border-slate-200">
        <div className="relative z-10 max-w-md">
          ...
          <div className="flex gap-4">
            <Link href="/projects" className="inline-flex items-center bg-brand-navy hover:bg-brand-navy/90 text-white px-8 py-4 rounded-xl font-semibold transition-all hover:shadow-lg">
              View Available Properties
            </Link>
            <Link href="/resources/voucher-calculator" className="inline-flex items-center text-brand-navy hover:bg-brand-navy hover:text-white font-semibold px-4 py-4 border border-brand-navy rounded-xl hover:shadow-lg transition-all">
